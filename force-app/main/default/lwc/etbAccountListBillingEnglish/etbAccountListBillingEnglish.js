...
import { OMNIDEF } from './etbAccountListBillingEnglish_def.js';
import tmpl from './etbAccountListBillingEnglish.html';
import tmpl_nds from './etbAccountListBillingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbAccountListBillingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
