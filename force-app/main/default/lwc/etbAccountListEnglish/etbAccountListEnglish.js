...
import { OMNIDEF } from './etbAccountListEnglish_def.js';
import tmpl from './etbAccountListEnglish.html';
import tmpl_nds from './etbAccountListEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbAccountListEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
