...
import { OMNIDEF } from './etbAccountListServiceEnglish_def.js';
import tmpl from './etbAccountListServiceEnglish.html';
import tmpl_nds from './etbAccountListServiceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbAccountListServiceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
