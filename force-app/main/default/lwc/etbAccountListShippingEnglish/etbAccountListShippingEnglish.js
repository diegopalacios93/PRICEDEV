...
import { OMNIDEF } from './etbAccountListShippingEnglish_def.js';
import tmpl from './etbAccountListShippingEnglish.html';
import tmpl_nds from './etbAccountListShippingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbAccountListShippingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
