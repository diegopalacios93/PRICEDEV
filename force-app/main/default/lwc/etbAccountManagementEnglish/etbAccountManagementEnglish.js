...
import { OMNIDEF } from './etbAccountManagementEnglish_def.js';
import tmpl from './etbAccountManagementEnglish.html';
import tmpl_nds from './etbAccountManagementEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbAccountManagementEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
