...
import { OMNIDEF } from './etbAjusteCostoPreciosSpanish_def.js';
import tmpl from './etbAjusteCostoPreciosSpanish.html';
import tmpl_nds from './etbAjusteCostoPreciosSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbAjusteCostoPreciosSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
