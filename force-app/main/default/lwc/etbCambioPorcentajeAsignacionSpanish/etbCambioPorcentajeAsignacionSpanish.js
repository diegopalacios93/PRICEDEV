...
import { OMNIDEF } from './etbCambioPorcentajeAsignacionSpanish_def.js';
import tmpl from './etbCambioPorcentajeAsignacionSpanish.html';
import tmpl_nds from './etbCambioPorcentajeAsignacionSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbCambioPorcentajeAsignacionSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
