...
import { OMNIDEF } from './etbClientSearchEnglish_def.js';
import tmpl from './etbClientSearchEnglish.html';
import tmpl_nds from './etbClientSearchEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbClientSearchEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
