...
import { OMNIDEF } from './etbContactAssingmentEnglish_def.js';
import tmpl from './etbContactAssingmentEnglish.html';
import tmpl_nds from './etbContactAssingmentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbContactAssingmentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
