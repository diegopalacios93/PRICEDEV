...
import { OMNIDEF } from './etbConvertLeadEnglish_def.js';
import tmpl from './etbConvertLeadEnglish.html';
import tmpl_nds from './etbConvertLeadEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbConvertLeadEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
