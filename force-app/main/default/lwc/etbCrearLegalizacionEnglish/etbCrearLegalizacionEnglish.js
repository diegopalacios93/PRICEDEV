...
import { OMNIDEF } from './etbCrearLegalizacionEnglish_def.js';
import tmpl from './etbCrearLegalizacionEnglish.html';
import tmpl_nds from './etbCrearLegalizacionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbCrearLegalizacionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
