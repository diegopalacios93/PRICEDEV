...
import { OMNIDEF } from './etbCreateNewCustomerEnglish_def.js';
import tmpl from './etbCreateNewCustomerEnglish.html';
import tmpl_nds from './etbCreateNewCustomerEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbCreateNewCustomerEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
