...
import { OMNIDEF } from './etbCreateSpecialOpportunityEnglish_def.js';
import tmpl from './etbCreateSpecialOpportunityEnglish.html';
import tmpl_nds from './etbCreateSpecialOpportunityEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbCreateSpecialOpportunityEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
