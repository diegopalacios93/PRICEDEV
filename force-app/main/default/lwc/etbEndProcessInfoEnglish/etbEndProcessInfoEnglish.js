...
import { OMNIDEF } from './etbEndProcessInfoEnglish_def.js';
import tmpl from './etbEndProcessInfoEnglish.html';
import tmpl_nds from './etbEndProcessInfoEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbEndProcessInfoEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
