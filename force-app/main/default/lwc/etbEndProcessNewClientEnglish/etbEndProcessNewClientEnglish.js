...
import { OMNIDEF } from './etbEndProcessNewClientEnglish_def.js';
import tmpl from './etbEndProcessNewClientEnglish.html';
import tmpl_nds from './etbEndProcessNewClientEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbEndProcessNewClientEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
