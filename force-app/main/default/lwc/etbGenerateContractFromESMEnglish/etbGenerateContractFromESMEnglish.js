...
import { OMNIDEF } from './etbGenerateContractFromESMEnglish_def.js';
import tmpl from './etbGenerateContractFromESMEnglish.html';
import tmpl_nds from './etbGenerateContractFromESMEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbGenerateContractFromESMEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
