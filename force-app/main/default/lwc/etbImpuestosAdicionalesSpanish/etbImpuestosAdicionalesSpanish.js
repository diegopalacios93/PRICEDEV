...
import { OMNIDEF } from './etbImpuestosAdicionalesSpanish_def.js';
import tmpl from './etbImpuestosAdicionalesSpanish.html';
import tmpl_nds from './etbImpuestosAdicionalesSpanish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbImpuestosAdicionalesSpanish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
