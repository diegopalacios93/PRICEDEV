...
import { OMNIDEF } from './etbLegalizationOrdersEnglish_def.js';
import tmpl from './etbLegalizationOrdersEnglish.html';
import tmpl_nds from './etbLegalizationOrdersEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbLegalizationOrdersEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
