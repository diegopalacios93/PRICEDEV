...
import { OMNIDEF } from './etbManageDiscountEnglish_def.js';
import tmpl from './etbManageDiscountEnglish.html';
import tmpl_nds from './etbManageDiscountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbManageDiscountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
