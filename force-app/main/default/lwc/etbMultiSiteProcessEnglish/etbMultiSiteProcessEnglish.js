...
import { OMNIDEF } from './etbMultiSiteProcessEnglish_def.js';
import tmpl from './etbMultiSiteProcessEnglish.html';
import tmpl_nds from './etbMultiSiteProcessEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbMultiSiteProcessEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
