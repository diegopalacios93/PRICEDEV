...
import { OMNIDEF } from './etbNotStandardAddressEnglish_def.js';
import tmpl from './etbNotStandardAddressEnglish.html';
import tmpl_nds from './etbNotStandardAddressEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbNotStandardAddressEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
