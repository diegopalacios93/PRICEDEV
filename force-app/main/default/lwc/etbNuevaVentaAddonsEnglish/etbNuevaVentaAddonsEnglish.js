...
import { OMNIDEF } from './etbNuevaVentaAddonsEnglish_def.js';
import tmpl from './etbNuevaVentaAddonsEnglish.html';
import tmpl_nds from './etbNuevaVentaAddonsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbNuevaVentaAddonsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
