...
import { OMNIDEF } from './etbNuevaVentaEnglish_def.js';
import tmpl from './etbNuevaVentaEnglish.html';
import tmpl_nds from './etbNuevaVentaEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbNuevaVentaEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
