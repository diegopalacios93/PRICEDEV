...
import { OMNIDEF } from './etbOrderValidationNewEnglish_def.js';
import tmpl from './etbOrderValidationNewEnglish.html';
import tmpl_nds from './etbOrderValidationNewEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbOrderValidationNewEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
