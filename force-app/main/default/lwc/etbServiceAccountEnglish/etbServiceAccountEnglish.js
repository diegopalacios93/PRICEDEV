...
import { OMNIDEF } from './etbServiceAccountEnglish_def.js';
import tmpl from './etbServiceAccountEnglish.html';
import tmpl_nds from './etbServiceAccountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbServiceAccountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
