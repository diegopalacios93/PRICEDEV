...
import { OMNIDEF } from './etbShippingAddressEnglish_def.js';
import tmpl from './etbShippingAddressEnglish.html';
import tmpl_nds from './etbShippingAddressEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbShippingAddressEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
