...
import { OMNIDEF } from './etbUpdateBillingAccountEnglish_def.js';
import tmpl from './etbUpdateBillingAccountEnglish.html';
import tmpl_nds from './etbUpdateBillingAccountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbUpdateBillingAccountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
