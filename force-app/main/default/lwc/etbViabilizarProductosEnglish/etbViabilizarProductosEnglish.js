...
import { OMNIDEF } from './etbViabilizarProductosEnglish_def.js';
import tmpl from './etbViabilizarProductosEnglish.html';
import tmpl_nds from './etbViabilizarProductosEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class etbViabilizarProductosEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
